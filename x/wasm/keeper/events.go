...
// to this event.
func newWasmModuleEvent(customAttributes []wasmvmtypes.EventAttribute, contractAddr sdk.WasmAddress) (sdk.Events, error) {
...
func newCustomEvents(evts wasmvmtypes.Events, contractAddr sdk.WasmAddress) (sdk.Events, error) {
...
func contractSDKEventAttributes(customAttributes []wasmvmtypes.EventAttribute, contractAddr sdk.WasmAddress) ([]sdk.Attribute, error) {
