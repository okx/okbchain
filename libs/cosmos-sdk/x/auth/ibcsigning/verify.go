...
import (
	...
	"github.com/okx/brczero/libs/cosmos-sdk/crypto/types/multisig"
...
func VerifySignature(pubKey cryptotypes.PubKey, signerData SignerData, sigData signing.SignatureData, handler SignModeHandler, tx ibctx.Tx) error {
