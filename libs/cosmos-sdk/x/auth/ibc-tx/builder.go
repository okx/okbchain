...
import (
	...
	sigtx "github.com/okx/brczero/libs/cosmos-sdk/x/auth/ibcsigning"
)
...
func (w *wrapper) GetMsgs() []ibcmsg.Msg {
	return w.tx.GetMsgs()
}
...
func (w *wrapper) GetFee() sdk.CoinAdapters {
...
func (w *wrapper) SetMsgs(msgs ...ibcmsg.Msg) error {
...
func (w *wrapper) SetFeeAmount(coins sdk.CoinAdapters) {
	if w.tx.AuthInfo.Fee == nil {
		w.tx.AuthInfo.Fee = &tx.Fee{}
	}
