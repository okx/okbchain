...
type DenomUnit struct {
	// denom represents the string name of the given denom unit (e.g okb).
	Denom string `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty"`
	// exponent represents power of 10 exponent that one must
	// raise the base_denom to in order to equal the given DenomUnit's denom
	// 1 denom = 1^exponent base_denom
	// (e.g. with a base_denom of okb, one can create a DenomUnit of 'okb' with
	// exponent = 6).
...
func (m *Input) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Coins = append(m.Coins, types.CoinAdapter{})
...
func (m *Supply) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Total = append(m.Total, types.CoinAdapter{})
