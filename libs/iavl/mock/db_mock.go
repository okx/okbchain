...
// Source: /Users/oker/workspace/okbchain/libs/tm-db/types.go
...
// GetUnsafeValue mocks base method.
func (m *MockDB) GetUnsafeValue(key []byte, processor db.UnsafeValueProcessor) (interface{}, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUnsafeValue", key, processor)
	ret0, _ := ret[0].(interface{})
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUnsafeValue indicates an expected call of GetUnsafeValue.
func (mr *MockDBMockRecorder) GetUnsafeValue(key, processor interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUnsafeValue", reflect.TypeOf((*MockDB)(nil).GetUnsafeValue), key, processor)
}
...
// Delete mocks base method.
func (m *MockSetDeleter) Delete(key []byte) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Delete", key)
}

// Delete indicates an expected call of Delete.
func (mr *MockSetDeleterMockRecorder) Delete(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockSetDeleter)(nil).Delete), key)
}

// Set mocks base method.
func (m *MockSetDeleter) Set(key, value []byte) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Set", key, value)
}

// Set indicates an expected call of Set.
func (mr *MockSetDeleterMockRecorder) Set(key, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockSetDeleter)(nil).Set), key, value)
}
