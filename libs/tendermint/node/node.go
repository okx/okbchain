...
import (
	...
	bcv0 "github.com/okx/brczero/libs/tendermint/blockchain/v0"
	bcv1 "github.com/okx/brczero/libs/tendermint/blockchain/v1"
	bcv2 "github.com/okx/brczero/libs/tendermint/blockchain/v2"
	...
	"github.com/okx/brczero/libs/tendermint/p2p/pex"
	"github.com/okx/brczero/libs/tendermint/privval"
	"github.com/okx/brczero/libs/tendermint/proxy"
	rpccore "github.com/okx/brczero/libs/tendermint/rpc/core"
	ctypes "github.com/okx/brczero/libs/tendermint/rpc/core/types"
	grpccore "github.com/okx/brczero/libs/tendermint/rpc/grpc"
	rpcserver "github.com/okx/brczero/libs/tendermint/rpc/jsonrpc/server"
...
func createPEXReactorAndAddToSwitch(addrBook pex.AddrBook, config *cfg.Config,
	...
	pexReactor := pex.NewReactor(addrBook,
		&pex.ReactorConfig{
			...
			// https://github.com/okx/okbchain/libs/tendermint/issues/3523
...
func (n *Node) startRPC() ([]net.Listener, error) {
	...
	// See https://github.com/okx/okbchain/libs/tendermint/issues/3435
