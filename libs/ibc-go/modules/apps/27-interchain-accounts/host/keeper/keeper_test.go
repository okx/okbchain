...
func (suite *KeeperTestSuite) TestGetInterchainAccountAddress() {
	...
	expectedAddr := icatypes.GenerateAddress(suite.chainA.GetSimApp().SupplyKeeper.GetModuleAddress(icatypes.ModuleName), ibctesting.FirstConnectionID, counterpartyPortID)
