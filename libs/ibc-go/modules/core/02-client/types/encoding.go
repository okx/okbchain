...
func MustUnmarshalClientState(cdc *codec.CodecProxy, bz []byte) exported.ClientState {
...
// failure.
func UnmarshalClientState(cdc *codec.CodecProxy, bz []byte) (exported.ClientState, error) {
...
// raw encoded bytes. It panics on error.
func MustMarshalClientState(cdc *codec.CodecProxy, clientState exported.ClientState) []byte {
...
func MarshalClientState(cdc *codec.CodecProxy, clientStateI exported.ClientState) ([]byte, error) {
...
// raw encoded bytes. It panics on error.
func MustUnmarshalConsensusState(cdc *codec.CodecProxy, bz []byte) exported.ConsensusState {
...
// raw encoded bytes. It panics on error.
func MustMarshalConsensusState(cdc *codec.CodecProxy, consensusState exported.ConsensusState) []byte {
...
func MarshalConsensusState(cdc *codec.CodecProxy, cs exported.ConsensusState) ([]byte, error) {
...
// raw encoded bytes. It panics on error.
func MustMarshalHeader(cdc *codec.CodecProxy, header exported.Header) []byte {
