...
func (cs ClientState) Status(_ sdk.Context, _ sdk.KVStore, _ *codec.CodecProxy,
) exported.Status {
...
func (cs ClientState) Initialize(_ sdk.Context, _ *codec.CodecProxy, _ sdk.KVStore, consState exported.ConsensusState) error {
	if consState != nil {
...
func (cs *ClientState) CheckHeaderAndUpdateState(
	ctx sdk.Context, _ *codec.CodecProxy, _ sdk.KVStore, _ exported.Header,
...
func (cs ClientState) CheckMisbehaviourAndUpdateState(
	_ sdk.Context, _ *codec.CodecProxy, _ sdk.KVStore, _ exported.Misbehaviour,
...
func (cs ClientState) CheckSubstituteAndUpdateState(
	ctx sdk.Context, _ *codec.CodecProxy, _, _ sdk.KVStore,
...
func (cs ClientState) VerifyUpgradeAndUpdateState(
	_ sdk.Context, _ *codec.CodecProxy, _ sdk.KVStore,
...
func (cs ClientState) VerifyClientState(
	store sdk.KVStore, cdc *codec.CodecProxy,
...
func (cs ClientState) VerifyConnectionState(
	...
	err := cdc.GetProtocMarshal().UnmarshalBinaryBare(bz, &prevConnection)
	if err != nil {
		return err
	}
...
func (cs ClientState) VerifyChannelState(
	...
	err := cdc.GetProtocMarshal().UnmarshalBinaryBare(bz, &prevChannel)
	if err != nil {
		return err
	}
