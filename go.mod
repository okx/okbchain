...
replace (
	...
	//github.com/ethereum/go-ethereum => /Volumes/E/project/github.com/okex/go-ethereum
	github.com/ethereum/go-ethereum => github.com/okx/go-ethereum v1.10.26-0.20230314085838-852ff10405bf
